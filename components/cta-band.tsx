    ...
    <section className="bg-safety-black px-4 py-10 text-white sm:px-6 sm:py-12">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-3xl">
          <p className="inline-block bg-safety-yellow px-3 py-1 text-xs font-black uppercase tracking-[0.2em] text-safety-black">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            href={primaryHref}
            className="bg-safety-yellow px-5 py-3 text-sm font-black uppercase text-safety-black hover:bg-white"
          >
            {primaryLabel}
          </Link>
          <Link
